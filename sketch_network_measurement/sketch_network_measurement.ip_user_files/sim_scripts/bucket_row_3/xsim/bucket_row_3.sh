...
#
# Script generated by Vivado on Fri Apr 03 16:46:18 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bucket_row_3.sh
...
#
# Usage        : bucket_row_3.sh
#                bucket_row_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bucket_row_3.sh [-rerun]
#                bucket_row_3.sh [-reset_run]
#                bucket_row_3.sh [-clean]
#                bucket_row_3.sh [-reset_log]
#                bucket_row_3.sh [-help]
#
...
# script info
echo -e "bucket_row_3.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bucket_row_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bucket_row_3 xil_defaultlib.bucket_row_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bucket_row_3 -key {Behavioral:top:Functional:bucket_row_3} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bucket_row_3.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bucket_row_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bucket_row_3.sh [-help]\n\
Usage: bucket_row_3.sh [-step]\n\
Usage: bucket_row_3.sh [-lib_map_path]\n\
Usage: bucket_row_3.sh [-rerun]\n\
Usage: bucket_row_3.sh [-reset_run]\n\
Usage: bucket_row_3.sh [-clean]\n\
Usage: bucket_row_3.sh [-reset_log]\n\
Usage: bucket_row_3.sh [-keep_index]\n\
Usage: bucket_row_3.sh [-noclean_files]\n\n\
