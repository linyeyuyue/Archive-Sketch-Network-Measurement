...
#                script (type 'bucket_row_1.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/vivado_projects/sketch_network_measurement/sketch_network_measurement.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
