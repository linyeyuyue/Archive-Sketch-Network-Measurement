...
REM
REM Generated by Vivado on Mon May 04 04:26:54 +0800 2026
...
echo "xvlog --incr --relax -prj bucket_row_tb_vlog.prj"
call xvlog  --incr --relax -prj bucket_row_tb_vlog.prj -log xvlog.log
