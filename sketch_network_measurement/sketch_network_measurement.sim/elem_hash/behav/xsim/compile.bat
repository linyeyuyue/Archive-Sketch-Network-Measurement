...
REM
REM Generated by Vivado on Mon May 04 04:22:32 +0800 2026
...
echo "xvlog --incr --relax -prj elem_hash_tb_vlog.prj"
call xvlog  --incr --relax -prj elem_hash_tb_vlog.prj -log xvlog.log
