...
REM
REM Generated by Vivado on Mon May 04 04:46:45 +0800 2026
...
echo "xvlog --incr --relax -prj bucket_refresh_tb_vlog.prj"
call xvlog  --incr --relax -prj bucket_refresh_tb_vlog.prj -log xvlog.log
