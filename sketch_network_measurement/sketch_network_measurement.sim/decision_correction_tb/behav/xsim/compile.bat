...
REM
REM Generated by Vivado on Mon May 04 04:40:19 +0800 2026
...
echo "xvlog --incr --relax -prj decision_correction_tb_vlog.prj"
call xvlog  --incr --relax -prj decision_correction_tb_vlog.prj -log xvlog.log
