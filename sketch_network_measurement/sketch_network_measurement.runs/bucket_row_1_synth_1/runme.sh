...
HD_PWD='F:/vivado_projects/sketch_network_measurement/sketch_network_measurement.runs/bucket_row_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bucket_row_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bucket_row_1.tcl
